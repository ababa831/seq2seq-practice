...
- 4層のLSTM
    ...
    - 更なる詳細
        ...
        - LSTMは勾配損失はあまり気にしなくていいけど，勾配爆発の可能性は考えないとだめ．勾配のノルムに強い制約を課す．ノルム値が閾値を超えたらスケーリングする．
            -  (後でスケーリング式を書く)
        - 系列の長さは，大部分は20-30程度の短さであるが，一部に100以上の長さもある．つまり，バッチの中には多数の短文とわずかな長文がランダムに選ばれる．これにより，殆どのミニバッチ計算は無駄になってしまう．この問題に対処するために，各ミニバッチではだいたい同じ長さの文章が含まれるようにした．これによって，2倍の処理速度になった．
